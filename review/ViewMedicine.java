...
public class ViewMedicine extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(859, 56, 1, 10));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Medcine ID", "Name", "Compan Name", "Quantity", "Price"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 820, 394));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Click On Row To Delete Medicine");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(344, 462, -1, -1));
    ...
    int a=JOptionPane.showConfirmDialog(null,"Do Yo Want To Delete This Medicine","Select",JOptionPane.YES_NO_OPTION);
    if(a==0){
        try{
             Connection con=ConnectionProvider.getCon();
